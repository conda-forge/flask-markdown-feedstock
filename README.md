About flask-markdown-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-markdown-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5902&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-markdown-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-markdown` can be installed with `conda`:
...
```
mamba install flask-markdown
```

It is possible to list all of the versions of `flask-markdown` available on your platform with `conda`:
...
```
mamba search flask-markdown --channel conda-forge
```
...
mamba repoquery search flask-markdown --channel conda-forge

# List packages depending on `flask-markdown`:
mamba repoquery whoneeds flask-markdown --channel conda-forge

# List dependencies of `flask-markdown`:
mamba repoquery depends flask-markdown --channel conda-forge
```
